 ...
 */
public class DiscriminatorColumnApp {
    private static String DATABASE_JDBC_URL = "jdbc:h2:~/DiscriminatorColumn";
    ...
    public static void main(String[] args) {
        ...
        // change tenant in EntityManager Level
        em.setProperty(PersistenceUnitProperties.MULTITENANT_PROPERTY_DEFAULT, "TWJUG");
        em.find(Product.class, 1L);
